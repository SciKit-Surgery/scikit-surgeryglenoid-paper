...
\begin{figure}
	...
	\end{center}
		...
		\end{subfigure}	
	\end{center}
	\caption{\label{fig:visualisations}Visualisations of the 2 plane, Friedman and Vault methods and of new axial slice plane used for corrected Friedman method. Additional visualisations of the axial slices of hte Friedman and vault methods to show point selection. By default uses the colour blind friendly palette defined by Wong\cite{bang2011}}
\end{figure}
